...
uint256 hashGenesisBlock("0x40d2323df82e732b72242bd501649dd959e5ba99ebc21f4b268e2b9936ad2c7a");
...
const string strMessageMagic = "SunCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // SunCoin: 1 days
static const int64 nTargetSpacing = 120; // SunCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal suncoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SunCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7c5fc5d95ec6317961f2a2d6fa48c2c9e7714ded32cf790d45ca3b7c0fa07f85");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1503381611; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2049724;

        if (fTestNet)
        {
            block.nTime    = 1502784541;
            block.nNonce   = 120334;
        }
